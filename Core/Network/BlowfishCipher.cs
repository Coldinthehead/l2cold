...
namespace Core.Network
{
    ...
    {
        private BlowfishEngine _cipher;
    ...
    public class BlowfishEngine
    {
        ...
        private readonly int[] S0; // the s-boxes
        private readonly int[] S1; // the s-boxes
        private readonly int[] S2; // the s-boxes
        private readonly int[] S3; // the s-boxes
         ...
         */
        public void tryEncryptBlock(byte[] src, int srcIndex)
        {
            if (workingKey == null)
            {
         ...
         */
        public void tryEncryptBlock(byte[] src, int srcIndex, byte[] dst, int dstIndex)
        {
            if (workingKey == null)
            {
                throw new Exception("Blowfish not initialized");
         ...
         * @throws IOException The source array is too small to hold a block at the given index
         */
        public void tryDecryptBlock(byte[] src, int srcIndex)
        {
            if (workingKey == null)
            {
                throw new Exception("Blowfish not initialized");
         ...
         * @throws IOException The source or destination array is too small to hold a block at the given index
         */
        public void tryDecryptBlock(byte[] src, int srcIndex, byte[] dst, int dstIndex)
        {
            if (workingKey == null)
            {
                throw new Exception("Blowfish not initialized");
         ...
         */
        private void bits32ToBytes(int x, byte[] dst, int dstIndex)
        {
            dst[dstIndex] = (byte)x;
            dst[dstIndex + 1] = (byte)(x >> 8);
            dst[dstIndex + 2] = (byte)(x >> 16);
            dst[dstIndex + 3] = (byte)(x >> 24);
        }
    }
